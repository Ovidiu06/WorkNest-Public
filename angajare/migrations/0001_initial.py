    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tip_contract', models.CharField(choices=[('determinat', 'Determinat'), ('nedeterminat', 'Nedeterminat')], default='nedeterminat', help_text='Selectați tipul contractului', max_length=50)),
                ('mod_de_lucru', models.CharField(choices=[('birou', 'Birou'), ('hibrid', 'Hibrid'), ('remote', 'Remote')], default='birou', help_text='Selectați modul de lucru', max_length=50)),
                ('active', models.BooleanField(default=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tip_document', models.CharField(help_text='Introduceți tipul documentului (ex: CI, contract, diploma etc.)', max_length=100)),
